...
/**
 * Card status, with its own badge rather than an addition to the payments
 * StatusBadge — cards have their own state machine, and coupling them means a
 * card change can break the payments table.
 */
